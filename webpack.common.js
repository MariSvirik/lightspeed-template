...
module.exports = (env) => {
  return {
    ...
    resolve: {
      ...
      // React Router v7's package "exports" + ESM re-exports can confuse webpack's analysis and
      // surface "module has no exports" for useLocation / NavLink / etc. Point at the CJS build.
      alias: {
